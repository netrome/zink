//! Browser client spike (A6): prove a browser can reach the relay's mailbox
//! ALPN through the iroh-relay WebSocket path and round-trip one frame.
//! Kept as the seed of the post-MVP PWA client (`web/spike`).
